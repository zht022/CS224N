...
def cross_entropy_loss(y, yhat):
    ...
    """
    prod = tf.multiply(tf.to_float(y), tf.log(yhat)) # element-wise product
    loss_per_sample = - tf.reduce_sum(prod, axis=1)
    out = tf.reduce_sum(loss_per_sample)
    return out
