...
class NERModel(Model):
    ...
    def fit(self, sess, saver, train_examples_raw, dev_set_raw):
        ...
        for epoch in range(self.config.n_epochs):
            ...
            # Note that get_minibatches could either return a list, or a list of list [features, labels].
            # This makes expanding tuples into arguments (* operator) handy
            ...
            logger.info("Entity level P/R/F1: %.3f/%.3f/%.3f", *entity_scores)
